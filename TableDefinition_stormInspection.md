# Purpose of Document #
Detailed Scheme Description of stormInspection table
### Field Details ###
```
...
Field: inspkey       Alias: inspkey              Data Type: int                Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source: Derived
       [description]

Field: newScore      Alias: newScore             Data Type: float              Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: downFrom      Alias: convertSetDownFrom   Data Type: float              Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: downTo        Alias: convertSetDownTo     Data Type: float              Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: readKey       Alias: readingKey           Data Type: int                Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source: Derived
       [description]


Field: startDtTm     Alias: startDtTm            Data Type: datetime           Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: compDtTm      Alias: compDtTm             Data Type: datetime           Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: instDate      Alias: instDate             Data Type: datetime           Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source: Hansen
...
Field: obDegree      Alias: obDegree             Data Type: nvarchar(6)        Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: obKey         Alias: obKey                Data Type: int                Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: rating        Alias: rating               Data Type: float              Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {}                  Source:
       [description]

Field: own           Alias: ownership            Data Type: nvarchar(4)        Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
...
Field: unitType      Alias: unittype             Data Type: nvarchar(6)        Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
                     Domain: {A, ABML, AB-ML, C, CSCC, CS-CC, CSDET, CS-DET, CSINT, CS-INT, CSML, CS-ML, CSOC, CSOTN,
                              CSPINT, CSPL,CS-PL, D, DET, EMBPG, EMBPP, EMERBP, F, FD, IC, ID, IS, IT, O, PC, PD, PS,
                              S, SAINT, SA-INT, SAML,SA-ML, SAPINT, SAPL, SA-PL, SPCNX, STCV, ST-CV, STCX, ST-CX,
                              STDET, ST-DET, STFC, ST-FC, STFD, ST-FD,STINF, ST-INF, STINT, ST-INT, STML, ST-ML, STPL,
                              ST-PL, V, X, Z}
                     Source: Hansen
...
Field: servStat      Alias: serviceStatus        Data Type: nvarchar(4)        Nulls: yes
                     Unique: no                  Index: no                     Default Value: none
