...
CREATE procedure [GIS].[USP_REHAB_6UPDATEFROMTRANSFERTABLE_2_10] AS
BEGIN
...
UPDATE REHAB10FTSEGS  SET 
	...
	[std_dev_whole] = 12
FROM  REHAB_RedundancyTableWhole AS A INNER JOIN REHAB10FTSEGS AS B ON A.MLinkID = B.MLinkID AND A.MlinkID < 40000000
...
UPDATE B SET remarks = 'BES' FROM REHAB10FTSEGS AS A INNER JOIN REHAB10FTSEGS AS B ON A.COMPKEY = B.COMPKEY AND A.MlinkID < 40000000 AND B.MlinkID >=40000000 AND A.remarks = 'BES'
...
UPDATE REHAB10FTSEGS  SET Fail_yr_whole =2040, RULife = 30 WHERE ACTION = 3 AND MlinkID < 40000000
UPDATE REHAB10FTSEGS  SET Fail_yr_whole =2130, RULife = 0 WHERE ACTION = 2 AND MlinkID < 40000000
UPDATE REHAB10FTSEGS  SET Fail_yr_whole =2130, RULife = 120 WHERE ACTION = 6 AND MlinkID < 40000000
UPDATE REHAB10FTSEGS  SET Fail_yr_whole =2130, RULife = 120 WHERE ACTION = 7 AND MlinkID < 40000000
UPDATE REHAB10FTSEGS  SET Fail_yr_whole =2130, RULife = 120 WHERE ACTION = 8 AND MlinkID < 40000000
